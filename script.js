...
confirmaSenhaInput.addEventListener("blur", (e) =>{
  let valorConfimaSenha = e.target.value  

  if(valorConfimaSenha == ""){
    confirmaSenhaHelper.innerText = "O campo não pode estar vazio."
    estilizarInputIncorreto(confirmaSenhaInput, confirmaSenhaHelper)
    inputsCorretos.confirmaSenha = false
  }else if(valorConfimaSenha !== senhaInput.value){
...
btnSubmit.addEventListener("click", (e) =>{
  if(inputsCorretos.username == false ||
    ...
    inputsCorretos.confirmaSenha == false){
    e.preventDefault()
    alert("Os campos obrigatórios precisam ser preenchidos corretamentes.")
  }else{
